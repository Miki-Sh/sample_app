...
class UsersIndexAdminTest < UsersIndexAdmin
  ...
  test "有効化されたユーザーだけが表示される" do
    # ページにいる最初のユーザーを無効化する。（無効なユーザーを作成するだけでは、Railsで最初のページに表示される保証がないので不十分）
